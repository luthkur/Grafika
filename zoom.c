    ...
    while (1) {
        ...
        else if((X == 'a') || (X == 'A'))
        {
            if(tooglebangunan == 1)
            {
                ...
                for(int i = 0; i < bangunan.PolyCount; i++)
                {
                    bangunan.arr[i].r = 0;
                }
                movePolylineArray(&bangunan, 0,0);
            }
            else
            {
                tooglebangunan = 1;
        ...
        else if((X == 's') || (X == 'S'))
        {
            if(tooglejalan == 1)
            {
                ...
                for(int i = 0; i < jalan.PolyCount; i++)
                {
                    jalan.arr[i].r = 0;
                    jalan.arr[i].g = 0;
                    jalan.arr[i].b = 0;
                }
                movePolylineArray(&jalan, 0,0);
            }
            else
            {
                tooglejalan = 1;
        ...
        else if((X == 'd') || (X == 'D'))
        {
            if(tooglepohon == 1)
            {
                ...
                for(int i = 0; i < pohon.PolyCount; i++)
                {
                    pohon.arr[i].g = 0;
                }
                movePolylineArray(&pohon, 0,0);
            }
            else
            {
                tooglepohon = 1;
